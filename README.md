...
3. [Built-in Combinators](#built-in-combinators)
4. [Reduction Strategy](#reduction-strategy)
5. [REPL Commands](#repl-commands)
6. [Name Definitions](#name-definitions)
7. [`.ski` Library Files](#ski-library-files)
8. [Standard Library — `init.ski`](#standard-library--initski)
...
9. [Encoding Conventions](#encoding-conventions)
